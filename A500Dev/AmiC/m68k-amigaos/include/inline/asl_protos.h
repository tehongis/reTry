...
APTR __AllocAslRequest(__reg("a6") void *, __reg("d0") ULONG reqType, __reg("a0") CONST struct TagItem * tagList)="\tjsr\t-48(a6)";
#define AllocAslRequest(reqType, tagList) __AllocAslRequest(AslBase, (reqType), (tagList))

#if !defined(NO_INLINE_STDARG) && (__STDC__ == 1L) && (__STDC_VERSION__ >= 199901L)
APTR __AllocAslRequestTags(__reg("a6") void *, __reg("d0") ULONG reqType, ...)="\tmove.l\ta0,-(a7)\n\tlea\t4(a7),a0\n\tjsr\t-48(a6)\n\tmovea.l\t(a7)+,a0";
#define AllocAslRequestTags(...) __AllocAslRequestTags(AslBase, __VA_ARGS__)
#endif
...
BOOL __AslRequest(__reg("a6") void *, __reg("a0") APTR requester, __reg("a1") CONST struct TagItem * tagList)="\tjsr\t-60(a6)";
#define AslRequest(requester, tagList) __AslRequest(AslBase, (requester), (tagList))

#if !defined(NO_INLINE_STDARG) && (__STDC__ == 1L) && (__STDC_VERSION__ >= 199901L)
BOOL __AslRequestTags(__reg("a6") void *, __reg("a0") APTR requester, ...)="\tmove.l\ta1,-(a7)\n\tlea\t4(a7),a1\n\tjsr\t-60(a6)\n\tmovea.l\t(a7)+,a1";
#define AslRequestTags(...) __AslRequestTags(AslBase, __VA_ARGS__)
#endif
