...
#define InstallClipRegion(layer, region) ({ \
  ...
  struct Region * _InstallClipRegion_region = (region); \
  ({ \
  register char * _InstallClipRegion__bn __asm("a6") = (char *) (LAYERS_BASE_NAME);\
  ((struct Region * (*)(char * __asm("a6"), struct Layer * __asm("a0"), struct Region * __asm("a1"))) \
...
#define InstallLayerInfoHook(li, hook) ({ \
  ...
  struct Hook * _InstallLayerInfoHook_hook = (hook); \
  ({ \
  register char * _InstallLayerInfoHook__bn __asm("a6") = (char *) (LAYERS_BASE_NAME);\
  ((struct Hook * (*)(char * __asm("a6"), struct Layer_Info * __asm("a0"), struct Hook * __asm("a1"))) \
...
#define DoHookClipRects(hook, rport, rect) ({ \
  struct Hook * _DoHookClipRects_hook = (hook); \
  ...
  ((VOID (*)(char * __asm("a6"), struct Hook * __asm("a0"), struct RastPort * __asm("a1"), CONST struct Rectangle * __asm("a2"))) \
...
#define LayerOccluded(layer) ({ \
  ...
  ((BOOL (*)(char * __asm("a6"), struct Layer * __asm("a0"))) \
...
#define ShowLayer(layer, in_front_of) ({ \
  struct Layer * _ShowLayer_layer = (layer); \
  struct Layer * _ShowLayer_in_front_of = (in_front_of); \
  ({ \
  register char * _ShowLayer__bn __asm("a6") = (char *) (LAYERS_BASE_NAME);\
  ((LONG (*)(char * __asm("a6"), struct Layer * __asm("a0"), struct Layer * __asm("a1"))) \
  (_ShowLayer__bn - 234))(_ShowLayer__bn, _ShowLayer_layer, _ShowLayer_in_front_of); \
});})

#define SetLayerInfoBounds(li, bounds) ({ \
  struct Layer_Info * _SetLayerInfoBounds_li = (li); \
  CONST struct Rectangle * _SetLayerInfoBounds_bounds = (bounds); \
  ({ \
  register char * _SetLayerInfoBounds__bn __asm("a6") = (char *) (LAYERS_BASE_NAME);\
  ((BOOL (*)(char * __asm("a6"), struct Layer_Info * __asm("a0"), CONST struct Rectangle * __asm("a1"))) \
