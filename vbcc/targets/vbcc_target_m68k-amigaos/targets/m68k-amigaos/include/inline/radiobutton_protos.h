...
struct Node * __AllocRadioButtonNode(__reg("a6") void *, __reg("d0") ULONG columns, ...)="\tmove.l\ta0,-(a7)\n\tlea\t4(a7),a0\n\tjsr\t-36(a6)\n\tmovea.l\t(a7)+,a0";
#define AllocRadioButtonNode(...) __AllocRadioButtonNode(RadioButtonBase, __VA_ARGS__)
#endif
